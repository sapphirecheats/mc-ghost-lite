...
public class GuiAddAlt extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.username = new GuiTextField(2, mc.fontRendererObj, width / 2 - 100, 60, 200, 20);
    ...
    private class AddAltThread extends Thread {
        ...
        private void checkAndAddAlt(String username, String password) throws IOException {
            ...
            try {
                auth.logIn();
                altManager.add(new MojangAlt(username, password));
        ...
        public void run() {
            if (this.password.equals("")) {
                GuiAddAlt.this.altManager.add(new MojangAlt(username, ""));
